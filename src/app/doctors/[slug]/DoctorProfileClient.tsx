...
export default function DoctorProfileClient({ doctor }: { doctor: Specialist }) {
        ...
        <Card className="overflow-hidden mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="relative md:col-span-1 bg-primary/5 min-h-[250px] md:min-h-0 aspect-square">
                    {doctorImage && <Image src={doctorImage.imageUrl} alt={doctor.name} width={400} height={400} className="object-cover w-full h-auto" data-ai-hint={doctor.hint} />}
                </div>
