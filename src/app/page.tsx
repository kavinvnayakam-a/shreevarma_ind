...
export default function HomePage() {
  ...
  const getImageUrl = (path: string) => {
    // Removed hourly timestamp to enable browser caching for better speed
  ...
  // Database speed optimization: Limit query to 4
  ...
  return (
    <div className="flex flex-col bg-white">
      {/* 1. Hero Section - Speed & Console Fixed */}
              ...
              <CarouselItem key={index} className="pl-0">
                <div className="w-full relative min-h-[300px] md:min-h-[368px] aspect-square md:aspect-[1400/368] rounded-b-2xl overflow-hidden bg-white">
                    ...
                    <Image 
                      ...
                      loading={index === 0 ? "eager" : "lazy"} 
                      fetchPriority={index === 0 ? "high" : "low"}
                      // Fix for console warning: accurately describing the desktop container width
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold font-headline text-center text-primary mb-12 uppercase tracking-tight">Shop by Category</h2>
      ...
      <section className="py-16 bg-white border-t border-slate-50 min-h-[400px]">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold font-headline text-primary mb-12 uppercase tracking-tight">Featured Products</h2>
          {isLoadingProducts ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
              {featuredProducts?.map((p) => (
                <ProductCard key={p.__docId} product={{...p, id: p.__docId}} />
              ))}
            </div>
          )}
        </div>
      ...
      {/* 4. Combo Offers - Fixed setApi Prop Error */}
      <section className="py-16 bg-white border-t border-slate-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold font-headline text-center text-primary mb-12 uppercase tracking-tight">Combo Offers</h2>
              ...
              {comboOfferData.map((combo, index) => (
                <CarouselItem key={index} className="pl-4 md:basis-1/2">
                  <Link href={`/products/${combo.productId}`} className="block group text-center">
                    ...
                    <h3 className="font-bold bg-primary text-white mt-4 p-3 rounded-xl shadow-md">{combo.title}</h3>
                  </Link>
                </CarouselItem>
              ))}
            </CarouselContent>
      ...
      <section className="py-24 bg-white border-t border-slate-50">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl font-black font-headline text-primary uppercase tracking-tighter">Our Story</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold font-headline text-primary mb-8 uppercase tracking-tight">Quality & Trust</h2>
          <div className="flex justify-center">
            <div className="relative w-full max-w-4xl aspect-[3750/710] min-h-[80px] bg-white">
              <Image 
                src={getImageUrl('site_assets/homepage/cert_gmp.png')} 
                alt="Trust Banner" 
                fill 
      ...
      <section className="py-24 bg-white border-t border-slate-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold font-headline text-center text-primary mb-12 uppercase tracking-tight">In The Spotlight</h2>
          <Carousel opts={{ loop: true, align: "start" }} plugins={[Autoplay({ delay: 6000 })]} className="w-full max-w-5xl mx-auto">
            <CarouselContent>
              {magazineImages.map((media, index) => (
                <CarouselItem key={index} className="sm:basis-1/2 md:basis-1/3 p-4">
          ...
          <div className="flex justify-center mt-16">
            <div className="relative w-full max-w-4xl aspect-[3750/710] min-h-[100px]">
              <Image 
                src={getImageUrl('site_assets/homepage/trendsetters_award.webp')} 
                alt="Award" 
                fill 
      ...
      <section className="py-24 bg-white border-t border-slate-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-black font-headline text-center text-primary mb-16 uppercase tracking-tighter">Words of Wellness</h2>
            ...
            {[
              ...
              <Card key={i} className="p-10 border-none bg-white rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 border-t-4 border-t-primary">
                <CardContent className="p-0">
                  ...
                  <p className="font-black text-primary tracking-widest uppercase text-sm">— {t.name}</p>
                </CardContent>
              </Card>
            ))}
          </div>
