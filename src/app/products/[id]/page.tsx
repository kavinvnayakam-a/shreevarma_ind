  ...
  if (isProductLoading || !productId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-background">
        ...
        <p className="mt-4 text-xs font-bold uppercase tracking-widest text-primary/40">Loading Wellness...</p>
      </div>
    );
  }
                ...
                <div className="hidden md:flex flex-col gap-4">
                    <div className="flex gap-4">
                        ...
                        <Button 
                          ...
                          size="lg" 
                          className="flex-grow rounded-2xl h-14 font-black uppercase tracking-widest bg-white text-primary border-2 border-primary hover:bg-primary hover:text-white transition-all"
                        >
                             Add to Cart
                        </Button>
                    </div>
                    <Button 
                      size="lg" 
                      className="w-full h-14 rounded-2xl bg-[#6f3a2f] hover:bg-[#5f2f27] text-white font-black uppercase tracking-widest shadow-xl" 
